...
public class ItemRestController {
	...
	public ResponseEntity<Void> marcarFeiro (@PathVariable Long idItem,@RequestBody String strFeito){
		
		try {
			JSONObject jsonObject = new JSONObject(strFeito);
			itemDao.marcarFeito(idItem, jsonObject.getBoolean("feito"));
			//criação do headers
	...
	//Select Uma lista
		...
		public ItemLista listar(@PathVariable("id")long id){
			ItemLista listar = itemDao.listar(id);
			return listar;
		}
